...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      "Pour afficher un concert en haut de la page d'accueil (hero), le sélectionner dans la Page d'accueil → onglet Hero → « Concerts affichés dans le hero » (jusqu'à 3). Si rien n'est sélectionné, les 3 prochains concerts s'affichent automatiquement.",
    ],
  },
  {
