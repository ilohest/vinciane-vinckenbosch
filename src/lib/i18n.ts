...
export const ui = {
  fr: {
    ...
    'agenda.title': 'agenda',
    'agenda.more': 'plus de dates',
    'contact.title': 'contact',
    'media.cta': 'media',
    'media.video': 'vidéo',
    'meta.description': 'Vinciane Vinckenbosch, altiste belge. Soliste, chambriste, co-solo de la Niederbayerische Philharmonie.',
  },
  en: {
    'nav.agenda': 'agenda',
    'nav.contact': 'contact',
    ...
    'agenda.title': 'agenda',
    'agenda.more': 'more dates',
    'contact.title': 'contact',
    'media.cta': 'media',
    'media.video': 'video',
    'meta.description': 'Vinciane Vinckenbosch, Belgian violist. Soloist, chamber musician, co-principal violist of the Niederbayerische Philharmonie.',
  },
  de: {
    'nav.agenda': 'agenda',
    'nav.contact': 'kontakt',
    ...
    'nav.archives': 'archiv',
    'bio.title': 'biografie',
    'bio.download': 'biografie herunterladen →',
    'agenda.title': 'agenda',
